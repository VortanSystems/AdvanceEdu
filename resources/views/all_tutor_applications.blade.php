...
<div class="col-md-12">
    ...
    <div class="card" width="100%">
        <div class="card-header">
            <h5>My Applications To Teach</h5>
        </div>

        <div class="card-body">
            
       <?php
       $mentus=$tutorapplics[0]->course_id;
       $users=DB::select('select * from courses_by_admin where id=?',[$mentus]);
  ...
  @foreach ($users as $user)
             ...
             <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <img style="height: 200px; width: 100%; overflow: hidden;" class="card-img-top" src="../uploads/<?php echo$user->preview_image;?>" alt="Card image cap">
                                    </div>
                                    <div class="card-body">
                                        <h4 class="card-title mb-3"style="  height: 18px;
  width: 190px;
  padding: 0;
  overflow: hidden;
  position: relative;
  ...
  white-space: nowrap;
  color: #000;">{{ $user->course_name }}</h4>
                                        <p class="card-text">{{ $user->course_sub_title }}
                                        </p>
                             ...
                             <a href = 'edit/{{ $user->id }}'>Edit</a>
                                        ...
                                        @else
                                                    ...
                                                    @endif
                                                     ...
                                                     <p style="float: right" class="small"><a href="#" data-toggle="modal" data-target="#scrollmodal<?php echo$tutorapplics[0]->id;?>">Details</a> </p>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="scrollmodal<?php echo$tutorapplics[0]->id;?>" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            
                               
                                         <?php $courses_app_id = $tutorapplics[0]->application_status;?>   

                                        @if($courses_app_id=='declined')
                            
                                            <a href="/apply-to-teach/{{ $user->id }}"><span class="btn btn-danger">Re-Apply To Teach</span></a>

                                            @elseif($courses_app_id=='approved')
                                               <span class="btn btn-success rounded-pill">Approved</span> 


                                             @elseif($courses_app_id=='pending')
                                               <span class="btn btn-warning rounded-pill">Pending Verification</span> 
                                                     @endif
  ...
  <div class="courese-overview" id="overview">
                                ...
                                <div class="row">
                              @if($courses_app_id=='approved')
                                               <p>{!! $tutorapplics[0]->message !!} 
                                                </p>
@elseif($courses_app_id=='declined')
...
@elseif($courses_app_id=='Pending')
  ...
  <p>Your Application To Teach {{ $user->course_name }} Is Still Under review By The Administration And Once Reviewed, Your Results Will Be Open Here</p>
