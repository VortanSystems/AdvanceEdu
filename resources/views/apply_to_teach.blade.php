  ...
  @endif
        ...
        <div class="card-body">
            @if((Auth::user()->access_level)=='tutor')
                               ...
                               <form class="user" action = "/teachtoday" method = "post"  enctype="multipart/form-data">
    <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                ...
                                <input id="email" type="hidden" class="form-control" name="course_id" value="<?php echo$users[0]->id;?>" required autocomplete="email" autofocus>
                                ...
                                <input id="email" type="hidden" class="form-control" name="tutor_id" value="{{ Auth::user()->id }}" required autocomplete="email" autofocus>
        ...
        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Upload Your Resume') }}<br><small style="color:green">must be PDF</small></label>

       <div class="col-md-9">


                              <label class="btn btn-block btn-success rounded-pill"><input type="file"   hidden name="cv_name" required>  <i class="fas fa-cloud-upload-alt" aria-hidden="true"></i>  &nbsp;Click To Upload</label>
        ...
        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('ID Verification') }}<br><small style="color:green">Front & Back on single page</small></label>

       <div class="col-md-9">


                              <label class="btn btn-block btn-success rounded-pill"><input type="file"   hidden name="identifications" required>  <i class="fas fa-cloud-upload-alt" aria-hidden="true"></i>  &nbsp;Click To Upload</label>
        ...
        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Briefly Talk About Yourself') }}</label>
...
<div class="editor">
  ...
  <div class="content-area">
    ...
    Clear This Text Before You Type... 
    </div>
    ...
    <div class="modal-content" id="modalCreateLink">
      ...
      <button class="done">Done</button>
       ...
       <div class="col-md-9">
             ...
             <center><input id="email" class="btn btn-success rounded-pill" name="applytotech" type = 'submit' value = "&nbsp;&nbsp;&nbsp;&nbsp;Apply To Teach&nbsp;&nbsp;&nbsp;&nbsp;"/></center>                 
                            </div>
                        </div>
