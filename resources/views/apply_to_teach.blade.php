...
<form class="user" action = "/teachtoday/<?php echo$useris[0]->course_name;?>" method = "post"   enctype="multipart/form-data">
    <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
       ...
       <div class="col-md-9">
                 ...
                 <input id="email" type="hidden" class="form-control" name="course_id" value="<?php echo$useris[0]->id;?>" required autocomplete="email" autofocus>
       ...
       <div class="col-md-9">
        ...
        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('ID Verification') }}<br><small style="color:green">must be PDF</small></label>
       ...
       <div class="col-md-9">
             ...
             <center><input    id="email" class="btn btn-success rounded-pill" name="addcourse" type = 'submit' value = "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Apply To Teach&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"/></center>                 
                            </div>
                        </div>
