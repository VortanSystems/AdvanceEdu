...
@foreach ($usssers as $quser)
        ...
        <div class="profile-card-2">
            ...
            @if($tutaorapplic->profile_photo)
            <div style="height: 425px; overflow: hidden;">
            <img style="height: 426px;  overflow-x: hidden;" src="uploads/{{ $tutaorapplic->profile_photo }}" class="img img-responsive">
            </div>
            @else
  ...
  white-space: nowrap;
  ">{{ $tutaorapplic->name }}</div>
        

    <div class="profile-username"> 
          @if(($quser->tutor_status)=='active')
                            <span style="border:green; padding: 2px; background-color: green; color:white; width:100%; " class="btn btn-danger rounded-pill">&nbsp;&nbsp;&nbsp;Active&nbsp;&nbsp;&nbsp;</span>

                       
                        @elseif(($quser->tutor_status)=='disabled')

                        <span style="border:red; padding: 2px; background-color: red; color:white; width:100%; " class="btn btn-danger rounded-pill">&nbsp;&nbsp;&nbsp;Blocked&nbsp;&nbsp;&nbsp;</span>
        ...
        <div class="profile-icons"> <a style="color:white;text-decoration: underline;" href="/approved_tutor_detail/{{ $tutaorapplic->id }}">See More..</a> </div>
    </div>
</div>
...
.profile-card-1 {
    ...
    background-image: url(uploads/{{ $tutaorapplic->profile_photo }});
