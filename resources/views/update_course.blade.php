...
<form class="user" action = "/edit/<?php echo $users[0]->id; ?>" method = "post"   enctype="multipart/form-data">
    <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
       ...
       <div class="col-md-9">
                ...
                <select name="course_status" class="form-control">
                    ...
                    $finihas=$users[0]->course_status; if($finihas=='inactive')
       ...
       <div class="col-md-9">
                                <input   value="<?php echo$users[0]->course_name;?>"   id="email" type="text" class="form-control" name="course_title" required autocomplete="email" autofocus>
       ...
       <div class="col-md-9">
                                <input id="email" type="number" class="form-control" name="price" value="<?php echo$users[0]->course_price;?>" required autocomplete="email" autofocus>
...
<div class="form-group row">
       ...
       <div class="col-md-9">
                                <input    id="email" type="text" class="form-control" name="course_sub_title"  value="<?php echo$users[0]->course_sub_title;?>"  required autocomplete="email" autofocus>
       ...
       <div class="col-md-9">
                                <input   value="<?php echo$users[0]->course_short_escription;?>"  id="email" type="text" class="form-control" name="sub_description" required autocomplete="email" autofocus>
       ...
       <div class="col-md-9">
                              <label class="btn btn-block btn-success rounded-pill"><input type="file" required="true" hidden="true"  name="preview_image">Click To Upload</label>

                              <input type="hidden" value="<?php echo$users[0]->course_sub_title;?>"   name="preview_image">
...
<div class="editor">
  ...
  <div class="content-area">
    <div style="height: 250px;z-index: 100; overflow: scroll;" class="visuell-view" contenteditable>
  <?php echo$users[0]->course_description;?>
   ...
   <script>
    ...
    <textarea  id="summernote" class="html-view"  name="course_description"><?php echo$users[0]->course_description;?></textarea>
  </div>
</div>
    ...
    <div class="modal-content" id="modalCreateLink">
      ...
      <button class="done">Done</button>
       ...
       <div class="col-md-9">
             ...
             <center><input    id="email" class="btn btn-success rounded-pill" name="addcourse" type = 'submit' value = "Update Course"/></center>                 
                            </div>
                        </div>
