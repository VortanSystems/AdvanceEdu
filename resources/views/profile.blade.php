                                ...
                                <div class="au-card au-card--bg-white au-card-top-countries m-b-40">
                                    <div class="au-card-inner">
                                        <div class="table-responsive">
                                                ...
                                                <center style="color:white;">PROFILE PICTURE</center>
                                           
                                                   <form action="{{route('uploadfile')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                       <div class="form-group">
                           
                           <input type="file" class="form-control @error('image') is-invalid @enderror" autofocus="true" id ="name" name="image" value="{{Auth::user()->profile_photo}}">
                           @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
