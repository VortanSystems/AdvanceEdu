...
<br>
  ...
  @endif
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Update Your General Information</div>
                   ...
                   @endif
                    ...
                    @csrf
                       <div class="form-group">
                           ...
                           <input type="text" class="form-control @error('name') is-invalid @enderror" autofocus="true" id ="name" name="name" value="{{Auth::user()->name}}">
                           @error('name')
                          ...
                          <div class="form-group">
                           <label for="name"><strong>Telephone:</strong></label>
                           <input type="text" class="form-control @error('phone') is-invalid @enderror" autofocus="true" id ="name" name="phone" value="{{Auth::user()->phone}}">
                           @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="form-group">
                           ...
                           <input type="text" class="form-control @error('address') is-invalid @enderror" autofocus="true" id ="name" name="address" value="{{Auth::user()->address}}">
                           @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group">
                           ...
                           <input readonly="true" type="text" class="form-control  @error('email') is-invalid @enderror" id ="email" value="{{Auth::user()->email}}" name="email">
                            @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
...
<br>
<center><div class="card-header">Password Update</div></center>
<br>
                    ...
                    @csrf
                       <div class="form-group">
                           ...
                           <input type="password" class="form-control @error('old_password') is-invalid @enderror" autofocus="true" id ="name" name="old_password">
                           @error('old_password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                           ...
                           <input type="password" class="form-control @error('new_password') is-invalid @enderror" autofocus="true" id ="name" name="new_password" >
                           @error('new_password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="form-group">
                           ...
                           <input type="password" class="form-control @error('confirm_new_password') is-invalid @enderror" autofocus="true" id ="name" name="confirm_new_password" >
                                ...
                                <div class="au-card au-card--bg-white au-card-top-countries m-b-40">
                                    <div class="au-card-inner">
                                        <div class="table">
                                                ...
                                                <center><small style="color:black;height: 150px;">Dimensions 350 X 500px</small></center>

                                                @if(Auth::user()->profile_photo)
                             <img style="border-radius: 3px;" src="uploads/{{ Auth::user()->profile_photo }}" />
                                        @else
                            <center><i style="font-size:160px;" class="fa fa-user"></i></center>
                                                    @endif
            ...
            <form action="{{route('uploadfile')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                       <div class="form-group">
                           <br>
                         <label class="btn btn-block btn-success rounded-pill">  <input hidden="true" type="file" class="form-control @error('image') is-invalid @enderror" autofocus="true" id ="name" name="image" value="{{Auth::user()->profile_photo}}">
                             <input hidden="true" type="hidden" class="form-control @error('image') is-invalid @enderror" autofocus="true" id ="name" name="image" value="{{Auth::user()->profile_photo}}">
                            

                              <i class="fa fa-camera" aria-hidden="true"></i> Update</label>
                           @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
