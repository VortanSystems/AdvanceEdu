    ...
    <div class="main-body">
          ...
          <div class="row gutters-sm">
            <div class="col-md-4 mb-3">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                      ...
                      @if($minonte->profile_photo)

                            <div  style="height: 130px; width: 130px; border-radius: 100%; overflow: hidden;" >
                             <img  style="height: 130px; width: 130px;" class="card-img-top" src="../uploads/{{ $minonte->profile_photo }}" alt="Card image cap">

                             </div>
                                        @else
                            <i style="font-size:150px;"  class="fa fa-user"></i>
                                                    @endif
              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                    ...
                    <h6><center>Popular Library Publications</center></h6>
            ...
            <div class="col-md-8">
              ...
              <a class="btn btn-info " target="__blank" href="/user_edit/{{ $minonte->id }}">Edit</a>
              ...
              <div class="row gutters-sm">
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      <h6><center>Courses</center></h6>
                      
                    <?php 
                    $tutorscode=$minonte->id;
              $usssers =      DB::table('tutors_for_courses')
                        ->where('tutor_id','=',[$tutorscode])
                        ->get();
...
@foreach ($usssers as $quser)
                    ...
                    <?php 
                         ...
                         $tutorzcode=$quser->course_id;
              $uzers =      DB::table('courses_by_admin')
                        ->where('id','=',[$tutorzcode])
                        ->get();
                        ?>
                    
               @foreach($uzers as $uzars)     
                  

                   <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    
                    
                    <h6>{{ $uzars->course_name }}</h6>
                 ...
                 <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                   ...
                   <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                    ...
                    <span data-toggle="modal" data-target="#mediumModal" class="btn btn-block btn-warning rounded-pill">Students</span>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="mediumModalLabel">
                            {{ $minonte->name }}'s Students</h3>
                        ...
                        <div class="modal-body">
                         ...
                         $tutazcode=$minonte->id;
              $uzazrs =      DB::table('students_enrolled')
                        ->where('tutor_id','=',[$tutazcode])
                        ->get();
