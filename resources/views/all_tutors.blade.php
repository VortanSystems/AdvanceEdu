...
<div class="col-md-12">
  ...
  @if((Auth::user()->user_type)=='admin')
                                 ...
                                 <a  href="/active_tutors"><button class="btn btn-success rounded-pill" >Active Tutors</button></a>
...
<center><b><input type="search" placeholder="find tutor by name..." autofocus="true" autocomplete="false" class="form-control rounded-pill" name=""></b> </center>
<br>
