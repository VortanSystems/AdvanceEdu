...
<div class="row">
        ...
        <div class="profile-card-2">
            ...
            <?php if($users[0]->profile_photo)
            {?>
            <div style="height: 425px; overflow: hidden;">
            <img style="height: 426px;  overflow-x: hidden;" src="../uploads/<?php echo$users[0]->profile_photo;?>" class="img img-responsive">
            </div>
            <?php } else {?>
...
.profile-card-1 {
    ...
    background-image: url(uploads/<?php echo$users[0]->profile_photo;?>);
...
<form class="user" action = "/update_user/{{ $users[0]->id }}" method = "post"   enctype="multipart/form-data">
    <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
    
              

               <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('User Status') }}</label>



       <div class="col-md-9">

                <select name="user_status_activity" class="form-control">

                    <?php

                    $finihas=$users[0]->user_status_activity; if($finihas=='suspended')

                    {?> 
                    <option value="active" >Activated</option>
                     <option  value="blocked" >Blocked</option>
                       <option selected="true" value="suspended" >Suspended</option>
                                 <?php  } elseif($finihas=='active') {?> 

                     <option selected="true" value="active" >Activated</option>
                      <option  value="blocked" >Blocked</option>
                       <option  value="suspended" >Suspended</option>

                                 <?php } elseif($finihas=='blocked') {?>

                     <option  value="active" >Activated</option>
                      <option selected="true" value="blocked" >Blocked</option>
                       <option  value="suspended" >Suspended</option>
               ...
               <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('User Access Level ') }}</label>
       ...
       <div class="col-md-9">
                ...
                <select name="access_level" class="form-control">
                    ...
                    $finihas=$users[0]->access_level; if($finihas=='tutor')

                    {?> 
                    <option value="student" >Student</option>
                                <option selected="true" value="tutor" >Tutor</option>

                                 <?php  } elseif($finihas=='student') {?> 
        ...
        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Full Name') }}</label>

       <div class="col-md-9">
                                <input   value="<?php echo$users[0]->name;?>"   id="email" type="text" class="form-control" name="name" required autocomplete="email" >
                           ...
                           <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Contact E-mail') }}</label>

       <div class="col-md-9">
                                <input id="email" type="text" class="form-control" name="email" value="<?php echo$users[0]->email;?>" required autocomplete="email" >
...
<div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Contact Phone') }}</label>

       <div class="col-md-9">
                                <input    id="email" type="text" class="form-control" name="phone"  value="<?php echo$users[0]->phone;?>"  required autocomplete="email"  >
        ...
        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('Contact Address') }}</label>

       <div class="col-md-9">
                                <input   value="<?php echo$users[0]->address;?>"  id="email" type="text" class="form-control" name="address" required autocomplete="email"  >
        ...
        <div class="form-group row">
                            <label for="email" class="col-md-3 col-form-label text-md-right">{{ __('User Profile Photo') }}</label>

       <div class="col-md-9">
                              <label class="btn btn-block btn-warning rounded-pill"><input type="file" required="true" hidden="true"  name="image">Click To Upload</label>

                              <input type="hidden" value="<?php echo$users[0]->profile_photo;?>"   name="image">
       ...
       <div class="col-md-9">
             ...
             <center><input    id="email" class="btn btn-success rounded-pill" name="addcourse" type = 'submit' value = "&nbsp;&nbsp;&nbsp;Update User&nbsp;&nbsp;&nbsp;"/></center>                 
                            </div>
                        </div>
