              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                           @if((Auth::user()->user_type)=='admin')
                    @if((Auth::user()->id)==$minonte->id)
@else

              <a class="btn btn-success rounded-lg " target="__blank" href="/user_edit/{{ $minonte->id }}">Edit</a>
@endif
                        @else
...
@if((Auth::user()->id)==$minonte->id)
@else
<button class="btn btn-block btn-warning rounded-pill">Courses Offered</button>
...
@else
<button class="btn btn-block btn-warning rounded-pill">Tutors</button>
