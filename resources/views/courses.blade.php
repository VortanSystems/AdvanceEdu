...
<div class="col-md-12">
    ...
    <div class="card" width="100%">
        <div class="card-header">
                               ...
                               <a   href="/all_courses"><button class="btn btn-primary rounded-pill" >All Courses</button></a>


                                  <a style="float: right;" href="/add-course"><button class="btn btn-primary rounded-pill" ><i class="fa fa-plus"></i></button></a>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <?php $actionstatus=$user->course_status;?>
                            ...
                            <div class="service-bx">
                                ...
                                <div class="info-bx text-center">
                                    <div class="feature-box-sm radius bg-white">
                                       <a style="font-weight: bold; font-size:19px;" class=" text-primary" >{{ $user->course_price }} $ </a>
                                    </div>
                                    <h4><a href="#" style="  height: 18px;
  width: 250px;
  padding: 0;
  overflow: hidden;
  position: relative;
  ...
  white-space: nowrap;
   ">{!! $user->course_name !!}</a></h4>
         ...
         @if((Auth::user()->user_type)=='admin')
                                    ...
                                    <a href = 'edit/{{ $user->id }}' style="background-color: indigo; color:white; border:1px solid indigo;" class="btn btn-default rounded-pill"><i class="fa fa-pen"></i></a>

                                    @endif

                                     <a style="color:white; font-family:arial; font-family: 29px;" data-toggle="modal" data-target="#scrollmodal{{ $user->id }}" class="btn btn-warning rounded-pill">View More</a>
                            ...
                            <!-- modal scroll -->
            <div class="modal fade" id="scrollmodal{{ $user->id }}" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <a target="_blank" href="apply_to_study/{{ $user->id }}"><span class="btn btn-warning">Enroll</span></a>
                         </p>

                                        @elseif((Auth::user()->access_level)=='tutor')
                            
                                            <a href="/apply-to-teach/{{ $user->id }}"><span class="btn btn-success">Apply To Teach</span></a>
                     ...
                     <div >
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="courses-post">
                                <div style="height: 520px;overflow:hidden;" class="ttr-post-media media-effect">
                                    <a href="#"><img style="border-radius: 3px; width:100%;" src="uploads/<?php echo$user->preview_image;?>" alt=""></a>
                                </div>
                                <div class="ttr-post-info">
                                    <div class="ttr-post-title ">
                                        <h2 class="post-title">{{ $user->course_name }}</h2>
                                    </div>
                                    <div class="ttr-post-text">
                                        <p>{{ $user->course_short_escription }}</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                              ...
                              <span class="btn btn-primary">Enroll</span>
                                        ...
                                        @elseif((Auth::user()->access_level)=='tutor')
                                            ...
                                            <a href="/apply-to-teach/{{ $user->id }}"><span class="btn btn-primary">Apply To Teach</span></a>
