...
<div class="col-md-12">
    ...
    <div class="card" width="100%">
        <div class="card-header">
            <a style="font-size: 18px;text-align: center;" >Course List</a>
  ...
  color: #000;">{{ $user->course_name }}</h4>
                                        ...
                                        <p style="float: left" class="small">
                             ...
                             <a href = 'edit/{{ $user->id }}'>Edit</a>
                                        ...
                                        @else
                                                    ...
                                                    @endif
                                                     ...
                                                     <p style="float: right" class="small"><a href="#" data-toggle="modal" data-target="#scrollmodal{{ $user->id }}">Details</a> </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                              ...
                              <span class="btn btn-success">Apply To Study</span>
                         </p>
...
<!------------------------------------------------------------->
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                                              ...
                                              @if((Auth::user()->access_level)=='student')
                              <span class="btn btn-primary">Apply To Study</span>
                         </p>
