                             ...
                             <a href = 'edit/{{ $user->id }}'>Edit</a>
                                        ...
                                        @else
                                                    ...
                                                    @endif
                                                     ...
                                                     <p style="float: right" class="small"><a href="#" data-toggle="modal" data-target="#scrollmodal<?php echo$useszwrs[0]->id;?>">Details</a> </p>
                                    </div>
                                </div>
                            </div>
...
<div class="modal fade" id="scrollmodal<?php echo$useszwrs[0]->id;?>" tabindex="-1" role="dialog" aria-labelledby="scrollmodalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            
                               
                                         <?php $courses_app_id = $useszwrs[0]->tutor_status;?>   

                                        @if($courses_app_id=='blocked')
                            
                                            <a href="/apply-to-teach/{{ $user->id }}"><span class="btn btn-danger">Re-Apply To Teach</span></a>

                                            @elseif($courses_app_id=='active')
                                               <span class="btn btn-success rounded-pill">Approved To Teach</span> 


                                             @elseif($courses_app_id=='suspended')
