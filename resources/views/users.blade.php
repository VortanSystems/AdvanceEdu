...
<div class="col-md-12">
  ...
  @if((Auth::user()->user_type)=='admin')
                                 ...
                                 <a  href="/tutors"><button class="btn btn-success rounded-pill" >All Tutors</button></a>

                            


                                <a style="float: right;" href="/students"><button class="btn btn-primary rounded-pill" > All Students </button></a>
...
<center><b><input type="search" placeholder="find user by name..." autofocus="true" autocomplete="false" class="form-control rounded-pill" name=""></b> </center>
<br>
