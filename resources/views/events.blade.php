...
<div class="col-md-12">
    ...
    <div class="card" width="100%">
        ...
        <div class="card-body">
         ...
         <div class="container">
<div class="row">
    <div class="col-lg-6" style="border-radius: 5px;">
        <div class="card card-margin">
           
            <div class="">
                <div class="widget-49">
                    <div  style="border-radius: 3px; color:white; background-image: url('https://static.thehoneycombers.com/wp-content/uploads/sites/2/2016/09/Atlantis-04.jpg'); height: 250px;" class="widget-49-title-wrapper">
                  ...
                  <div class="card-body">
                    ...
                    <h3>Title Here</h3>
                    <span class="h5">Sub Title Here...</span>


                  </div>
                    <div class="widget-49-meeting-action">
                        <a href="#" style="color: white; font-family: monospace;" class="btn-warning btn rounded-pill"> Read More </a>
                    </div>
                    <br>
                </div>
            </div>
