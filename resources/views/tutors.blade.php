...
<div class="col-md-12">
  ...
  @if((Auth::user()->user_type)=='admin')
                                 ...
                                 <a  href="/all_tutors"><button class="btn btn-success rounded-pill" >All Tutors</button></a>

                            


                                <a style="float: right;" href="/applications-by-tutors"><button class="btn btn-primary rounded-pill" >Tutor Applications</button></a>
...
@else
 <div class="profile-icons"> <a style="color:white;text-decoration: underline;" href="/tutor_app_id/{{ $quser->id }}">See More..</a> </div>
